...
export const VERSION_CHANGELOG: VersionChangeSection[] = [
  {
    ...
    summary: 'バックアップのアカウントタブにレシピ・献立・カレンダーイベント・Gemini APIキー等の件数内訳をリアルタイム表示。レシピ詳細タイトルの視認性向上とモバイルカレンダーの日付選択UIを安定化。検索スコア計算を事前計算で最適化し、UIフィルター関数を独立ユーティリティに分離してテストを追加。',
    points: [
