...
export const VERSION_CHANGELOG: VersionChangeSection[] = [
  {
    ...
    summary: '起動・検索・配布構成を整理し、入力安定性とデプロイ検証を強化。',
    points: [
      '起動処理を fail-open 化し、重い再計算を後段へ移してスプラッシュ固着を防止',
      '検索入力を IME 安全な draft/commit 構成へ統一し、検索・在庫・差し替えUIの入力崩れを改善',
      'Playwright smoke を CI に追加し、主要導線の実動作確認を自動化',
      '画面を route 単位で lazy-load 化し、seed データを public 配信へ切り出して初期 bundle を軽量化',
    ],
    refs: ['v2.0.0', 'ca16f88'],
  },
  {
    title: 'V1.9.9 と V1.9.8 の差分',
    summary: '栄養推定の精度を上げ、買い物リストと周辺UXを実用寄りに改善。',
    points: [
      '人前・皿・膳などの単位変換と塩分計算を見直し、栄養推定を改善',
      '起動時の再推定で栄養充足率 0% 表示が出やすい問題を解消',
      '買い物リストを小売単位へ寄せ、カレンダー登録時の売場順も改善',
      '在庫管理やホーム導線、ログイン継続など周辺UXを調整',
    ],
    refs: ['v1.9.9'],
  },
  {
    title: 'V1.9.8 と V1.9.7 の差分',
    summary: 'バックアップ状況の見える化と検索・認証まわりの安定化を実施。',
    points: [
      'バックアップ対象件数をアカウントタブに表示し、保存状況を確認しやすく改善',
      'レシピ詳細タイトルとモバイル日付選択UIの視認性を改善',
      '検索スコア計算を事前計算化し、UIフィルターを独立ユーティリティへ整理',
      'Googleログインのサイレント更新失敗時の認証状態クリアを厳密化',
    ],
    refs: ['v1.9.8'],
  },
  {
