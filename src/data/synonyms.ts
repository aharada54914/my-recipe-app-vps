...
export const synonymMap: Record<string, string[]> = {
    // 肉類
    鶏肉: ['とり肉', 'とりにく', 'チキン', '鶏もも肉', '鶏むね肉', '鶏モモ肉', '鶏ムネ肉', '鶏ひき肉'],
    豚肉: ['ぶた肉', 'ぶたにく', 'ポーク', '豚バラ', '豚ロース', '豚こま', '豚ひき肉'],
    牛肉: ['ぎゅうにく', 'ビーフ', '牛バラ', '牛こま', '牛ひき肉', '牛すじ', '牛薄切り肉', '牛うす切り肉'],
    ひき肉: ['挽肉', 'ミンチ', '合いびき', '合挽き', '合びき肉'],
    ベーコン: ['ベイコン'],
    ...
    きぬさや: ['絹さや'],
    さといも: ['里芋', '里いも', 'サトイモ'],
    とうがらし: ['唐辛子', '赤とうがらし', '赤唐辛子', '青とうがらし', '鷹の爪'],
    ...
    マヨネーズ: ['マヨ'],
    ケチャップ: ['トマトケチャップ'],
    酒粕: ['粕', 'さけかす', 'かすづけ', '粕漬け', '酒かす'],
    ごま油: ['ゴマ油', 'セサミオイル'],
    片栗粉: ['かたくり粉', 'かたくりこ', 'でんぷん', '澱粉'],
    塩麹: ['塩こうじ', 'しおこうじ'],
    豆板醤: ['とうばんじゃん', 'ドウバンジャン'],
    七味: ['七味とうがらし', '七味唐辛子', 'しちみ', 'しちみとうがらし'],
    ゆずこしょう: ['柚子胡椒', '柚子こしょう'],
    甜麺醤: ['甜面醤', 'てんめんじゃん', 'テンメンジャン'],
    はちみつ: ['ハチミツ', '蜂蜜'],
