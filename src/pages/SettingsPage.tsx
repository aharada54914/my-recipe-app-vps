...
import { ArrowLeft, Settings, Eye, EyeOff, Lock, Unlock, Wifi, WifiOff, Download, Upload, LogIn, LogOut, User, Cloud, RefreshCw, Calendar, UtensilsCrossed, Bell, Database } from 'lucide-react'
                    ...
                    <>
                        {supabase ? (
                            ...
                            <div className="rounded-2xl bg-white/5 px-4 py-6 text-center">
                                <User className="mx-auto mb-2 h-8 w-8 text-text-secondary opacity-40" />
                                <p className="text-sm text-text-secondary">
                                    クラウド同期を使用するには Supabase の設定が必要です。
                                </p>
                            </div>
                        )}
                    </>
